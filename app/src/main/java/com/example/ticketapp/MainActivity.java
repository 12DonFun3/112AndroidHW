...
public class MainActivity extends AppCompatActivity {
    ...
    private void updateGender() {
        ...
        if (boy.isChecked()) {
            genderTextView.setText(getResources().getString(R.string.gender));
    ...
    private void updateTicketPrice() {
        ...
        if (selectedTypeId == R.id.rdbAdult) {
            ticketType = getResources().getString(R.string.ticketTYpe);
    ...
    private void handleSelection(Intent intent) {
        ...
        RadioButton girl = findViewById(R.id.rdbGirl);
        if (boy.isChecked())
            outputStr += getResources().getString(R.string.gender);
        else if (girl.isChecked())
            outputStr += getResources().getString(R.string.gender);
        ...
        if (type.getCheckedRadioButtonId() == R.id.rdbAdult) {
            outputStr += getResources().getString(R.string.ticketTYpe);
